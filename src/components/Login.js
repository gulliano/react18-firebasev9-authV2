...
<div class="h-full  w-full py-16 px-4">
            ...
            <div class="flex flex-col items-center justify-center">
                ...
                <div class="bg-white shadow rounded lg:w-1/3  md:w-1/2 w-full p-10 mt-16">
                    ...
                    <p class="focus:outline-none text-sm mt-4 font-medium leading-none text-gray-500">Dont have account? <Link  to="/signup">Sign up</Link></p>
                    <button  onClick={handleGoogleSignIn} aria-label="Continue with google" role="button" class="focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-gray-700 py-3.5 px-4 border rounded-lg border-gray-700 flex items-center w-full mt-10">
                    ...
                    <div class="w-full flex items-center justify-between py-5">
                        ...
                        <div>
                            ...
                            <input  onChange={(e) => setEmail(e.target.value)} aria-labelledby="email" type="email" class="bg-gray-200 border rounded  text-xs font-medium leading-none text-gray-800 py-3 w-full pl-3 mt-2"/>
                        </div>
                        <div class="mt-6  w-full">
                           ...
                           <div class="relative flex items-center justify-center">
                            <input onChange={(e) => setPassword(e.target.value)} id="pass" type="password" class="bg-gray-200 border rounded  text-xs font-medium leading-none text-gray-800 py-3 w-full pl-3 mt-2"/>
                        ...
                        <div class="mt-8">
                            <button onClick={handleSubmit} role="button" class="focus:ring-2 focus:ring-offset-2 focus:ring-indigo-700 text-sm font-semibold leading-none text-white focus:outline-none bg-indigo-700 border rounded hover:bg-indigo-600 py-4 w-full">Connexion</button>
                        </div>
                </div>
            </div>
        </div>
